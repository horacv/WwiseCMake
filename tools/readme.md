...
```
- **sdk_path**: Path to the Wwise SDK folder (e.g., `C:\Audiokinetic\Wwise2025.1.6.9117\SDK`).
- **platform**: `windows` or `mac`.

**Example:**
```bash
python install_wwise_sdk.py "C:\Audiokinetic\Wwise2025.1.6.9117\SDK" windows
```
