...
```
- **sdk_path**: Path to the Wwise SDK folder (e.g., `C:\Audiokinetic\Wwise2024.1.14.9084\SDK`).
- **platform**: `windows` or `mac`.

**Example:**
```bash
python install_wwise_sdk.py "C:\Audiokinetic\Wwise2024.1.14.9084\SDK" windows
```
